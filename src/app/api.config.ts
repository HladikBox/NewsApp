...
export class ApiConfig {
    ...
    public static getApiUrl() {
        return "http://cmsdev.helpfooter.com/alucard263096/newsapp/api/";
    }
    public static getUploadPath() {
        return "http://cmsdev.helpfooter.com/alucard263096/newsapp/upload/";
    }
    public static getFileUploadAPI() {
        return "http://cmsdev.helpfooter.com/alucard263096/newsapp/fileupload";
    }
    public static getDataBaseName() {
        return "alucard263096_newsapp.db";
    }
